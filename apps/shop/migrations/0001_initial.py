# -*- coding: utf-8 -*-
# Generated by Django 1.11.12 on 2018-06-07 01:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(storage=apps.shop.models.ImageStorage(), upload_to='banner/%Y%m%d', verbose_name='轮播图')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cate', models.ForeignKey(db_column='cate_id', on_delete=django.db.models.deletion.DO_NOTHING, to='shop.Category', verbose_name='父菜单')),
            ],
            options={
                'verbose_name': '商品属性',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('cate', models.ForeignKey(db_column='cate_id', on_delete=django.db.models.deletion.DO_NOTHING, to='shop.Category', verbose_name='商品分类')),
            ],
            options={
                'verbose_name': '商品信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_menu', models.ForeignKey(db_column='sub_menu_id', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='shop.SubMenu', verbose_name='父菜单')),
            ],
            options={
                'verbose_name': '二级菜单',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(upload_to='upload/img/%Y%m%d', verbose_name='头像')),
        ...
        migrations.AddField(
            model_name='order',
            name='user',
            field=models.ForeignKey(db_column='uid', on_delete=django.db.models.deletion.DO_NOTHING, to='shop.User', verbose_name='属性ID'),
        ),
    ]
